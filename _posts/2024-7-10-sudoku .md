...
[피셔 에이츠 셔플 알고리즘 ](https://github.com/enmael/Sudoku_-game)
...
<span style="font-size: 15px;">
   여기에 피셔 에이츠 셔플 알고리즘 설명 까지 적으면 많아질것 같으니 새로운 posts에 작성한다.
</span>
...
<span style="font-size: 15px;">
   코드 2 그림3 처럼 열을 분리하여 각각 2차원 배열 row1,row2,row3 에 저장을 합니다.
</span>
...
<span style="font-size: 15px;">
   코드3. 그림3 처럼 분리한 열을 썩어서 새로운 3x3 배열 rowArray1를 만듭니다.
</span>
...
<span style="font-size: 15px;">
   코드 4. 그림3 처럼 분리한 열을 썩어서 새로운 3x3 배열 rowArray2를 만듭니다.
</span>
