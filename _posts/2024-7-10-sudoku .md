...
<span style="font-size: 15px;">
코드1은 array 에 저장되어있는 값 1,2,3,4,5,6,7,8,9를 뒤에서 부터 랜덤한 자리와 셔플 하여 값을 변경 하는과정을 9번 반복하여 
  array 배열을 썩고 그렇게 나온 값들을 2차원 배열 arrray2에 저장을 합니다.
  저장된값들을 호출하여 사용할수 있게 public int Array2(int x, int y),public int rows(),public int cols()3개의 함수를 만듭니다.
  public int Array2(int x, int y)은 array2의 인덱스에 해당하는 값을 리턴, public int rows() array2의 열의 길이들 리턴
  public int cols()은 array2의 행의 길이를 리턴 합니다.
</span>
